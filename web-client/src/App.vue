...
// ==========================================
// 4. Computed Properties (คุณสมบัติคำนวณ)
// ==========================================
  ...
  >
    ...
    <header class="d-flex align-items-center mb-4">
      ...
      <div>
        ...
        <small class="text-muted">ทดสอบและตรวจสอบ API Endpoint อย่างรวดเร็วและทันสมัย</small>
      </div>
    </header>
            ...
            <div class="list-group list-group-flush">
              ...
              >
                <div class="d-flex justify-content-between align-items-start">
                  <span class="badge bg-primary bg-opacity-10 text-primary radius-md mb-1">
                    {{ preset.method }}
                  </span>
                  <small class="text-muted">{{ preset.category }}</small>
                </div>
                <div class="fw-semibold text-truncate text-primary" :title="preset.endpoint">
                  {{ preset.presetName }}
                </div>
                <small class="text-muted" style="font-size: 0.75rem">{{ preset.endpoint }}</small>
              </div>
            </div>
          </div>
        </aside>
        ...
        <section class="col-lg-9">
          ...
          <div class="modern-card p-4 mb-4">
            ...
            <div class="d-flex gap-2 mb-3 flex-wrap flex-md-nowrap">
              ...
              >
                <span v-if="isRequestLoading" class="spinner-border spinner-border-sm"></span>
            ...
            <ul class="nav nav-pills mb-3 gap-2">
              ...
              <li class="nav-item" v-if="['POST', 'PUT', 'PATCH'].includes(requestMethod)">
                <button
                  class="nav-link radius-md px-3"
                  :class="{
          ...
          <div v-if="apiResponse || requestError" class="modern-card p-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
              ...
              <div v-if="apiResponse" class="d-flex gap-2">
                <span class="badge bg-success bg-opacity-10 text-success radius-md px-3 py-2">
                  {{ apiResponse.statusCode }} {{ apiResponse.statusText }}
                </span>
                <span class="badge bg-primary bg-opacity-10 text-primary radius-md px-3 py-2">
                  <i class="bi bi-clock me-1"></i>{{ apiResponse.executionTime }} ms
                </span>
                <button
            ...
            <div v-if="requestError" class="alert alert-danger radius-md d-flex align-items-center">
    ...
    <footer class="mt-5 py-4 border-top text-center text-muted">
      <div class="container">
        ...
        <small class="d-block"> Developed with Vue.js 3, Bootstrap 5 & Bootstrap Icons </small>
        <small class="d-block mt-2 text-black-50" style="font-size: 0.75rem">
          &copy; <span id="copyright-year">{{ new Date().getFullYear() }}</span> PluemStudio
